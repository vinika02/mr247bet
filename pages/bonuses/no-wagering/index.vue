...
const pageTitle = 'Bonuses - No wagering | Mr247bet casino and reviews'
const pageDescription = "Looking for bonuses with no wagering requirements? Look no further than Mr247Bet! Enjoy no-wagering free spins and bonus cash with our top-rated online casinos."
...
useServerSeoMeta({
    ...
    ogImage: '/public/og/bonus.jpg',
    ogImageAlt: 'no-wagering-bonuses',
    ...
    twitterImage: '/public/og/bonus.jpg',
    twitterImageAlt: 'no-wagering-bonuses'
})
</script>

<template>
    <div>
        <BonusesHero categoryName="No Wagering Bonuses" />
        <main id="main">
            <BonusesFilterBy :mostPopularCasinos=items />
            <BonusesInfo />
            <BonusesFAQ />
        </main>
    </div>
