...
const pageTitle = 'Games - Roulette | Mr247bet casino and reviews'
const pageDescription = "Experience the excitement of the spinning wheel with our wide selection of roulette games at Mr247Bet! Place your bets and watch the ball land on your lucky number."
...
useServerSeoMeta({
    ...
    ogImage: '/public/og/games.jpg',
    ogImageAlt: 'roulette-games',
    ...
    twitterImage: '/public/og/games.jpg',
    twitterImageAlt: 'roulette-games'
})
...
<template>
    <div>
        <GamesHero categoryName="Roulette Games" />
        <main id="main">
            <GamesFilterBy :mostPopularCasinos=items />
            <GamesInfo />
            <GamesFAQ />
        </main>
    </div>
