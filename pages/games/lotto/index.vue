...
const pageTitle = 'Games - Lotto | Mr247bet casino and reviews'
const pageDescription = "Looking for a chance to hit the jackpot? Check out our selection of online lotto games at Mr247Bet and win big today! Play now and try your luck."
...
useServerSeoMeta({
    ...
    twitterImageAlt: 'lotto-games'
})
</script>

<template>
    <div>
        <GamesHero categoryName="Lotto Games" />
        <main id="main">
