...
const pageTitle = 'Games - Blackjack | Mr247bet casino and reviews'
const pageDescription = "Play the best online blackjack games at Mr247Bet. Discover different variations, rules, and strategies for a chance to win big. Join now and start playing!"
...
useServerSeoMeta({
    ...
    twitterImageAlt: 'blackjack-games'
})
</script>

<template>
    <div>
        <GamesHero categoryName="Blackjack Games" />
        <main id="main">
