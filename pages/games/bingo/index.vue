...
const pageTitle = 'Games - Bingo | Mr247bet casino and reviews'
const pageDescription = "Looking for some bingo fun? Mr247Bet has got you covered with a great selection of online bingo games. Join now and start daubing those numbers!"
...
useServerSeoMeta({
    ...
    twitterImageAlt: 'bingo-games'
})
</script>

<template>
    <div>
        <GamesHero categoryName="Bingo Games" />
        <main id="main">
