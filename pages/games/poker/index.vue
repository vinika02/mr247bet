...
const pageTitle = 'Games - Poker | Mr247bet casino and reviews'
const pageDescription = "Looking for a thrilling game of poker? Look no further than Mr247Bet's wide selection of poker games, including Texas Hold'em and Omaha. Join the action today!"
...
useServerSeoMeta({
    ...
    twitterImageAlt: 'poker-games'
})
</script>

<template>
    <div>
        <GamesHero categoryName="Poker Games" />
        <main id="main">
