...
const pageTitle = 'Games - Casino games | Mr247bet casino and reviews'
const pageDescription = "Looking for the ultimate gaming experience? Check out Mr247Bet's vast selection of top-rated casino games! From slots to table games, we've got it all."
...
useServerSeoMeta({
    ...
    twitterImageAlt: 'casino-games'
})
</script>

<template>
    <div>
        <GamesHero categoryName="Casino Games" />
        <main id="main">
