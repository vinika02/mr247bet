...
const pageTitle = 'Games - Baccarat | Mr247bet casino and reviews'
const pageDescription = "Experience the excitement of the classic casino game of Baccarat with Mr247Bet's top-rated selection of Baccarat games. Join now and play like a pro!"
...
useServerSeoMeta({
    ...
    twitterImageAlt: 'baccarat-games'
})
</script>

<template>
    <div>
        <GamesHero categoryName="Baccarat Games" />
        <main id="main">
