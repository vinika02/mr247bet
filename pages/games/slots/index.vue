...
const pageTitle = 'Games - Slots | Mr247bet casino and reviews'
const pageDescription = "Get lost in the world of spinning reels and endless possibilities with Mr247Bet's extensive selection of slot games. Play now and hit that jackpot!"
...
useServerSeoMeta({
    ...
    twitterImageAlt: 'slot-games'
})
</script>

<template>
    <div>
        <GamesHero categoryName="Slot Games" />
        <main id="main">
