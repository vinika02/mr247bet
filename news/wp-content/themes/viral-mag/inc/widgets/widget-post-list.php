 ...
 * @package Viral Mag
 */
add_action('widgets_init', 'viral_mag_register_post_list');

function viral_mag_register_post_list() {
    register_widget('viral_mag_post_list');
}

class viral_mag_post_list extends WP_Widget {
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'list_by' => array(
                'viral_mag_widgets_name' => 'list_by',
                'viral_mag_widgets_title' => esc_html__('List Post By', 'viral-mag'),
                'viral_mag_widgets_field_type' => 'select',
                'viral_mag_widgets_field_options' => array(
                    'latest-post' => esc_html__('Latest Post', 'viral-mag'),
                    'most-commented' => esc_html__('Most Commented', 'viral-mag'),
                    'most-viewed' => esc_html__('Most Viewed', 'viral-mag')
                ),
                'viral_mag_widgets_default' => 'latest-post'
            ),
            'post_count' => array(
            ...
            'display_counter' => array(
                'viral_mag_widgets_name' => 'display_counter',
                'viral_mag_widgets_title' => esc_html__('Display Counter', 'viral-mag'),
                'viral_mag_widgets_field_type' => 'checkbox',
            ),
    ...
    public function widget($args, $instance) {
        ...
        ?>
        <div class="vm-post-listing <?php echo esc_attr($layout); ?>">
            <?php
            $args = array(
                'post_type' => 'post',
            ...
            while ($query->have_posts()) : $query->the_post();
                ...
                <div class="vm-post-list vm-clearfix">
                    ...
                    <div class="vm-pl-image">
                        ...
                        <?php
                        if ($display_counter) {
                            echo '<span class="vm-pl-count">' . $index . '</span>';
                        }
                        ?>
                    </div>
