jQuery(document).ready(function ($) {
    $('.viral-mag-gradient-box').each(function () {
        var $pickerId = $(this).find('.viral-mag-gradient-picker');
        var $inputId = $(this).find('.viral-mag-gradient-val');
        var $previewId = $(this).find('.viral-mag-gradient-preview');
        var $directionId = $(this).find('.viral-mag-gradient-direction');
        var $customGradId = $(this).find('.viral-mag-gradient-custom')
        ...
        $directionId.on("change", function () {
            ...
            if (direction == 'custom') {
                ...
                orientation = $(this).closest('.viral-mag-gradient-box').find('.ui-slider-handle > span').text();
        ...
        $(this).find('.viral-mag-gradient-range').slider({
            range: "min",
            value: deg,
            min: 0,
            max: 360,
