...
class Viral_Mag_Preloader_Selector_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        if (!empty($this->choices)) {
            ...
            <label>
                ...
                <select class="viral-mag-preloader-selector" <?php $this->link(); ?>>
                    <?php
                ...
                <div class="viral-mag-preloader-container">
                    <?php
                    for ($i = 1; $i <= 16; $i++) {
                        $style = ($this->value() != 'preloader' . $i) ? 'style="display:none"' : '';
                        echo '<div class="viral-mag-preloader viral-mag-preloader' . $i . '"' . $style . '>';
