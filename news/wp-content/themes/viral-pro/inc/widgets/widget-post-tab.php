...
class viral_pro_post_tab extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        $tab_header = $tab_content = $title_style = $excerpt_style = "";
        $class = 'ht-pl-title';
        ...
        <div class="ht-post-tab">
            ...
            if (!empty($tabs)) {
                foreach ($tabs as $tab) {
                    ...
                    $tab_header .= '<div class="ht-pt-tab" data-id="' . $id . '">';
                    ...
                    $tab_content .= '<div class="ht-pt-content" id="' . $id . '">';
                    $tab_content .= '<div class="ht-post-listing animated faster ' . esc_attr($layout) . '">';
                    ob_start();
