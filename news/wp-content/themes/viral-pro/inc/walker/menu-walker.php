 ...
 *
 */
function viral_pro_header_style() {
    return 'horizontal';
}
...
if (!class_exists('Viral_Pro_Custom_Nav_Walker')) {
    ...
    class Viral_Pro_Custom_Nav_Walker extends Walker_Nav_Menu {
        ...
        public function start_lvl(&$output, $depth = 0, $args = array()) {
            ...
            if ($depth === 0 && $this->megamenu != '' && $this->megamenu != 'normal' && 'vertical' != viral_pro_header_style()) {
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
            ...
            // Mega menu
            if ($depth === 0 && $this->has_children && $item->category_post == '' && 'vertical' != viral_pro_header_style()) {
            ...
            if ($depth === 0 && $item->category_post != '' && $item->object == 'category' && 'vertical' != viral_pro_header_style()) {
            ...
            $item_output .= '</a>';
            if ($depth !== 0 && $item->megamenu_template && $this->megamenu != 'normal' && 'vertical' != viral_pro_header_style()) {
                ob_start();
            ...
            if ($depth !== 0 && $item->megamenu_widgetarea && $this->megamenu != 'normal' && 'vertical' != viral_pro_header_style()) {
                ob_start();
        ...
        public function end_el(&$output, $item, $depth = 0, $args = array()) {
            ...
            // Header style
            $header_style = viral_pro_header_style();

            if ($depth === 0 && $item->category_post != '' && 'vertical' != $header_style) {
