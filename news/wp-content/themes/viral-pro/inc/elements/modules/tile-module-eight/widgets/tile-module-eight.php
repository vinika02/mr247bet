...
class TileModuleEight extends Widget_Base {
    ...
    protected function render() {
        ...
        <div class="vl-tile-block-wrap <?php echo esc_attr($settings['image_hover_style']); ?>">
            ...
            <div class="vl-tile-block ht-clearfix style8 <?php echo esc_attr($gap); ?>">
                <?php
                    ...
                    <div class="<?php echo esc_attr($class); ?>">
                        <div class="vl-thumb-inner vl-post-thumb">
                            <a href="<?php the_permalink(); ?>">
                                <?php
                                if ($index == 1)
                                    viral_pro_elements_featured_image($featured_image_size);
                                else
                                    viral_pro_elements_featured_image($side_image_size);
                                ?>
                            </a>
