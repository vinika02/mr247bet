...
class NewsModuleEighteen extends Widget_Base {
    ...
    protected function render() {
        ...
        ?>
        <div class="vl-news-block style12 <?php echo esc_attr($settings['image_hover_style']); ?>">
                                ...
                                <div class="vl-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <div class="vl-thumb-container">
                                            <?php viral_pro_elements_featured_image($settings['featured_post_image_size']); ?>
                                        </div>
                                    </a>
                                    <?php
                        ...
                        <?php if ($index == 2) { ?>
                            ...
                            <div class="vl-post-item ht-clearfix">
                                <div class="vl-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <div class="vl-thumb-container">
                                            <?php viral_pro_elements_featured_image($settings['side_post_image_size']); ?>
                                        </div>
                                    </a>
                                    <?php
