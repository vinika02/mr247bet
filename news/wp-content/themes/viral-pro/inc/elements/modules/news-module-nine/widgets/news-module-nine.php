...
class NewsModuleNine extends Widget_Base {
    ...
    protected function render() {
        ...
        ?>
        <div class="vl-three-column-block <?php echo esc_attr($settings['image_hover_style']); ?>">

            <?php $this->render_header(); ?>

            <div class="vl-three-column-block-wrap">
                <?php
                    ...
                    if ($index == 1) {
                            ...
                            <div class="vl-post-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="vl-thumb-container">
                                        <?php viral_pro_elements_featured_image($featured_post_image_size); ?>
                                    </div>

                                    <div class="vl-post-content vl-gradient-overlay <?php echo esc_attr($content_align_class); ?>">
                                        <h3 class="vl-post-title vl-big-title"><span><?php the_title(); ?></span></h3>
                        ...
                        <div class="vl-post-item ht-clearfix">
                            <div class="vl-post-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="vl-thumb-container">
                                        <?php viral_pro_elements_featured_image($listing_post_image_size); ?>
                                    </div>
                                </a>
                            </div>
    ...
    protected function query_args() {
        ...
        $args['posts_per_page'] = intval($settings['listing_post_count']['size']) + 1;
