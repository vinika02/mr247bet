...
class NewsModuleSix extends Widget_Base {
                                ...
                                <div class="vl-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <div class="vl-thumb-container">
                                            <?php 
                                                viral_pro_elements_featured_image($top_block_image_size); 
                                            ?>
                                        </div>
                            ...
                            <div class="vl-post-item vl-clearfix">
                                <div class="vl-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <div class="vl-thumb-container">
                                            <?php 
                                                viral_pro_elements_featured_image($bottom_block_image_size); 
                                            ?>
                                        </div>
                                    </a>
                                    <?php
    ...
    protected function query_args() {
        ...
        $args['posts_per_page'] = intval($settings['bottom_post_count']['size']) + 1;
