...
class NewsModuleTwentytwo extends Widget_Base {
    ...
    protected function render() {
        ...
        ?>
        <div class="vl-news-block style5 <?php echo esc_attr($settings['image_hover_style']); ?>">
                    ...
                    if ($index == 1 || $index == 2) {
                        ...
                        <div class="vl-post-item ht-clearfix">
                            <div class="vl-post-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="vl-thumb-container">
                                        <?php viral_pro_elements_featured_image($listing_image_size); ?>
                                    </div>
                                </a>
                            </div>
    ...
    protected function query_args() {
        ...
        $args['posts_per_page'] = intval($settings['post_count']['size']);
