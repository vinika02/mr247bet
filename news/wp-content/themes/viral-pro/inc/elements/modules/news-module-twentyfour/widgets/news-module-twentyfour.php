...
class NewsModuleTwentyfour extends Widget_Base {
    ...
    protected function render() {
        ...
        $this->add_render_attribute('vl-news-module-class', 'class', [
            'vl-mininews-block',
            'style2',
            'vl-row',
            'vl-col-' . $settings['column_count']['size'],
            'vl-tablet-col-' . $column_count_tablet,
            'vl-mobile-col-' . $column_count_mobile
                ]
        );
        ?>
        <div class="<?php echo esc_attr($settings['image_hover_style']); ?>">
            <?php $this->render_header(); ?>
            <div <?php echo $this->get_render_attribute_string('vl-news-module-class'); ?>>
                <?php
                ...
                while ($query->have_posts()): $query->the_post();
                    ...
                    ?>
                    <div class="vl-post-item vl-post-list">
                        <div class="vl-post-thumb">
                            <a href="<?php the_permalink(); ?>">
                                <div class="vl-thumb-container">
                                    <?php viral_pro_elements_featured_image($image_size); ?>
                                </div>
                            </a>
                        </div>
