...
class TileModuleOne extends Widget_Base {
    ...
    protected function render() {
        ...
        ?>
        <div class="vl-tile-block-wrap <?php echo esc_attr($settings['image_hover_style']); ?>">
            <?php $this->render_header(); ?>
            <div class="vl-tile-block ht-clearfix style1 <?php echo esc_attr($gap); ?>">
                <?php
                    ...
                    if ($index == 1) {
                        ...
                        <div class="vl-width-50 vl-height-100 vl-thumb vl-left-col">
                            <div class="vl-thumb-inner vl-post-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    <?php viral_pro_elements_featured_image($featured_image_size); ?>
                                </a>
                        ...
                        if ($index == 2) {
                            ...
                            <div class="vl-width-100 vl-height-50 vl-thumb">
                                <div class="vl-thumb-inner vl-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <?php viral_pro_elements_featured_image($side_large_image_size); ?>
                                    </a>
                        ...
                        <?php if ($index > 2) { ?>
                            <div class="vl-width-50 vl-height-50 vl-thumb">
                                <div class="vl-thumb-inner vl-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <?php viral_pro_elements_featured_image($side_image_size); ?>
                                    </a>
