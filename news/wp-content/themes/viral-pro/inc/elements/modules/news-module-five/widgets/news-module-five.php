...
class NewsModuleFive extends Widget_Base {
    ...
    protected function render() {
        ...
        ?>
        <div class="vl-news-block style1 <?php echo esc_attr($settings['image_hover_style']); ?>">
            <?php $this->render_header(); ?>

            <div class="ht-clearfix vl-news-block-wrap ">
                <?php
                                ...
                                <div class="vl-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <div class="vl-thumb-container">
                                            <?php
                                            viral_pro_elements_featured_image($featured_post_image_size);
                                            ?>
                                        </div>
                                    </a>
                            ...
                            <div class="vl-post-item ht-clearfix">
                                <div class="vl-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <div class="vl-thumb-container">
                                            <?php
                                            viral_pro_elements_featured_image($listing_post_image_size);
                                            ?>
                                        </div>
                                    </a>
                                </div>
