...
final class Menu_Icons_Settings {
	...
	public static function _admin_notices() {
		$messages = array(
			'updated' => __( '<strong>Menu Icons Settings</strong> have been successfully updated.', 'viral-pro' ),
			'reset'   => __( '<strong>Menu Icons Settings</strong> have been successfully reset.', 'viral-pro' ),
		);
	...
	private static function _add_settings_meta_box() {
		add_meta_box(
			'menu-icons-settings',
			__( 'Menu Icons Settings', 'viral-pro' ),
	...
	public static function get_settings_fields( array $values = array() ) {
		$fields = array(
			'hide_label' => array(
				'id'      => 'hide_label',
				'type'    => 'select',
				'label'   => __( 'Hide Label', 'viral-pro' ),
				'default' => '',
				'choices' => array(
					array(
						'value' => '',
						'label' => __( 'No', 'viral-pro' ),
					),
					array(
						'value' => '1',
						'label' => __( 'Yes', 'viral-pro' ),
					),
				),
			),
			'position' => array(
				'id'      => 'position',
				'type'    => 'select',
				'label'   => __( 'Position', 'viral-pro' ),
				'default' => 'before',
				'choices' => array(
					array(
						'value' => 'before',
						'label' => __( 'Before', 'viral-pro' ),
					),
					array(
						'value' => 'after',
						'label' => __( 'After', 'viral-pro' ),
					),
				),
			),
			'vertical_align' => array(
				'id'      => 'vertical_align',
				'type'    => 'select',
				'label'   => __( 'Vertical Align', 'viral-pro' ),
				'default' => 'middle',
				'choices' => array(
					array(
						'value' => 'super',
						'label' => __( 'Super', 'viral-pro' ),
					),
					array(
						'value' => 'top',
						'label' => __( 'Top', 'viral-pro' ),
					),
					array(
						'value' => 'text-top',
						'label' => __( 'Text Top', 'viral-pro' ),
					),
					array(
						'value' => 'middle',
						'label' => __( 'Middle', 'viral-pro' ),
					),
					array(
						'value' => 'baseline',
						'label' => __( 'Baseline', 'viral-pro' ),
					),
					array(
						'value' => 'text-bottom',
						'label' => __( 'Text Bottom', 'viral-pro' ),
					),
					array(
						'value' => 'bottom',
						'label' => __( 'Bottom', 'viral-pro' ),
					),
					array(
						'value' => 'sub',
						'label' => __( 'Sub', 'viral-pro' ),
					),
				),
			),
			'font_size' => array(
	...
	public static function get_fields() {
		...
		$sections = array(
			'global' => array(
				'id'          => 'global',
				'title'       => __( 'Global', 'viral-pro' ),
				'description' => __( 'Global settings', 'viral-pro' ),
				'fields'      => array(
					array(
						'id'      => 'icon_types',
						'type'    => 'checkbox',
						'label'   => __( 'Icon Types', 'viral-pro' ),
						'choices' => $icon_types,
		...
		if ( ! empty( $menu_id ) ) {
			...
			$sections['menu'] = array(
				'id'          => $menu_key,
				'title'       => __( 'Current Menu', 'viral-pro' ),
				'description' => sprintf(
					__( '"%s" menu settings', 'viral-pro' ),
				...
				<span class="list-controls">
					<?php
						printf(
							...
							esc_attr__( 'Discard all changes and reset to default state', 'viral-pro' ),
							esc_html__( 'Reset', 'viral-pro' )
						);
					?>
				</span>
	...
	public static function _enqueue_assets() {
		...
		$js_data = apply_filters(
			...
			array(
				'text'           => array(
					'title'        => __( 'Select Icon', 'viral-pro' ),
					'select'       => __( 'Select', 'viral-pro' ),
					'remove'       => __( 'Remove', 'viral-pro' ),
					'change'       => __( 'Change', 'viral-pro' ),
					'all'          => __( 'All', 'viral-pro' ),
					'preview'      => __( 'Preview', 'viral-pro' ),
					'settingsInfo' => '',
				),
